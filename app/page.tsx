        ...
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-bg-card to-black border border-white/10 rounded-[2rem] md:rounded-[3rem] p-8 md:p-16 text-center relative overflow-hidden gsap-fade-up shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              <a href="/game/" className="w-full sm:w-auto px-6 py-4 rounded-xl font-bold border border-white/20 text-white flex items-center justify-center gap-3 hover:bg-white/5 transition-all text-sm md:text-base">
                <Smartphone size={20} />
