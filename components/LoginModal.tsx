        ...
        >
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              type="button"
              className="w-full bg-white/10 border border-white/30 text-white font-bold py-4 rounded-xl hover:bg-white/20 transition-colors flex items-center justify-center gap-3"
            >
